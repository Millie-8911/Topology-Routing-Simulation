...
host = '127.0.0.1'
router_1_soc = create_socket(host, 8002) # Connection between router 1 and 2
router_4_soc = create_socket(host, 8004) # Connection between router 1 and 4
...
# packets_table = read_csv('input/packets_test.csv')
