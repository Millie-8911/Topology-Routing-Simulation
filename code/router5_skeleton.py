...
# Start the server for Router 5 on port 8005
# Listen to port 8005 to get packets from Router 4
thread_8005 =threading.Thread(target=start_server, args=(8005, forwarding_table_with_range, default_gateway_port))
thread_8005.start()
