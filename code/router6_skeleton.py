...
# Start the server for Router 6 on port 8006
# Listen to port 8006 to get packets from Router 4
thread_8006 =threading.Thread(target=start_server, args=(8006, forwarding_table_with_range, default_gateway_port))
thread_8006.start()
